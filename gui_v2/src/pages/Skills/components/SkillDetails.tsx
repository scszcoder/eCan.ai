        ...
        <Space direction="vertical" style={{ width: '100%' }}>
            ...
            <Space>
                <Tag color={getStatusColor(skill.status)}>
                    <CheckCircleOutlined /> {t('pages.skills.status')}: {t(`pages.skills.status.${skill.status}`)}
                </Tag>
                <Tag color="blue">
                    <ThunderboltOutlined /> {t('pages.skills.category')}: {t(`pages.skills.categories.${skill.category}`)}
                </Tag>
            </Space>
            <Space>
                ...
                <Space direction="vertical" style={{ width: '100%' }}>
                    ...
                    <Text type="secondary"  style={{ color: 'white' }}>
                        {skill.level === 100
                            ...
                            : t('pages.skills.complete', { level: skill.level })}
                    </Text>
                </Space>
            </Card>
            <Space>
