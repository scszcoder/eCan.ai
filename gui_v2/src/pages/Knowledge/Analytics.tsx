...
const Analytics: React.FC = () => {
  ...
  const analyticsData: AnalyticsData = {
    ...
    growthRate: 12.5,
    topCategories: [
      { name: '技术文档', count: 67, percentage: 43 },
      { name: '产品文档', count: 45, percentage: 29 },
      { name: '管理文档', count: 32, percentage: 21 },
      { name: '其他', count: 12, percentage: 7 },
    ],
    topDocuments: [
      { title: '快速开始指南', views: 234, likes: 45, category: '技术文档' },
      { title: 'API 参考文档', views: 189, likes: 32, category: '技术文档' },
      { title: '用户权限管理', views: 156, likes: 28, category: '管理文档' },
      { title: '产品功能介绍', views: 134, likes: 25, category: '产品文档' },
      { title: '系统部署指南', views: 98, likes: 18, category: '技术文档' },
    ],
    recentActivity: [
      { type: 'create', title: '新增文档：数据库优化指南', user: '张三', time: '2小时前' },
      { type: 'edit', title: '更新文档：API接口说明', user: '李四', time: '4小时前' },
      { type: 'question', title: '提问：如何配置SSL证书？', user: '王五', time: '6小时前' },
      { type: 'answer', title: '回答：系统登录问题解决方案', user: '赵六', time: '8小时前' },
      { type: 'view', title: '查看文档：用户权限管理', user: '钱七', time: '10小时前' },
    ],
  };
