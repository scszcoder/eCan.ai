    ...
    return {
      ...
      data: {
        ...
        inputsValues: {
          ...
          browserProfileId: { type: 'constant', content: '' },
          ...
          // ── 2026-05-19 Fix B/C: dispatch-firing-rate controls.  Tri-state
          // ('' = use env / hardcoded default).  Defaults restore v0.9.79
          // behaviour: bypass ON, REARM OFF, B1 force-emit OFF.
          eventMonitorB1ForceEmit: { type: 'constant', content: '' },
          frontdeskRearmEnabled: { type: 'constant', content: '' },
          directFeigeBypassOnBackpressure: { type: 'constant', content: '' },
          systemPrompt: {
            type: 'template', 
        ...
        inputs: {
          ...
          properties: {
            ...
            browserProfileId: { type: 'string', extra: { formComponent: 'input' } },
            ...
            // Bool tri-state: '' = inherit env/default; '1' or 'true' = on; '0' or 'false' = off.
            eventMonitorB1ForceEmit: { type: 'string', extra: { formComponent: 'select' } },
            frontdeskRearmEnabled: { type: 'string', extra: { formComponent: 'select' } },
            directFeigeBypassOnBackpressure: { type: 'string', extra: { formComponent: 'select' } },
