...
Source: "ECBot\ECBot.exe"; DestDir: "{app}"
...
[Icons]
Name: "{group}\ECBot"; Filename: "{app}\ECBot\ECBot.EXE"; WorkingDir: "{app}"
...
begin
  { Create the pages }
  UserPrompt := 'Please specify your name and the company for whom you work, then click Next.'#13#10'������������Ϣ��Ȼ����Next��һ����';
  UserPage := CreateInputQueryPage(wpWelcome,
    'Personal Information(�û���Ϣ)', '', UserPrompt);
  UserPage.Add('Name(�û���):', False);
  ...
  UsagePage := CreateInputOptionPage(UserPage.ID,
    ...
    True, False);
  UsagePage.Add('Commander (Command Only, No mission Execution)ָ�ӹ�-���ɷ�����');
  UsagePage.Add('Commander (Command and Execute Mission)ָ�ӹ� - �ɷ���ִ������');
  UsagePage.Add('Platoon (Execute Mission Only) С�ֶ�-��ִ������');
...
begin
  Log('REG WRiting......');
  RegWriteStringValue(HKEY_CURRENT_USER, 'Environment', 'ECB_HOME', ExpandConstant('{app}'));
end;
