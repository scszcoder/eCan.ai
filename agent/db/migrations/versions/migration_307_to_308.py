...
class Migration_307_to_308(BaseMigration):
    ...
    def upgrade(self, session):
        ...
        try:
            ...
            self._set_default_values_for_existing_agents()
    ...
    def validate_postconditions(self, session):
        ...
        try:
            ...
            if not self._validate_table_columns('agents', ['default_input_modes', 'default_output_modes']):
                return False
    ...
    def _set_default_values_for_existing_agents(self):
