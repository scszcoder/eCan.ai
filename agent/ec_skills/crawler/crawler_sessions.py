...
from agent.ec_skills.browser.config import CONFIG
from agent.ec_skills.crawler.observability import observe_debug
from agent.ec_skills.crawler.utils import _log_pretty_path, _log_pretty_url
...
from agent.ec_skills.browser.profile import BROWSERUSE_DEFAULT_CHANNEL, BrowserChannel, BrowserProfile
from agent.ec_skills.browser.types import (
	Browser,
	BrowserContext,
	ElementHandle,
	FrameLocator,
...
# imports for heavy DOM services to improve startup time
from agent.ec_skills.dom.clickable_element_processor.service import ClickableElementProcessor
from agent.ec_skills.dom.service import DomService
from agent.ec_skills.dom.views import DOMElementNode, SelectorMap
from agent.ec_skills.crawler.utils import (
	is_new_tab_page,
...
class BrowserSession(BaseModel):
	...
	async def get_minimal_state_summary(self) -> BrowserStateSummary:
		...
		from agent.ec_skills.browser.views import BrowserStateSummary
