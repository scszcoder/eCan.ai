...
def set_up_ec_customer_support_agent(mainwin):
    try:
        ...
        customer_support = EC_Agent(mainwin=mainwin, skill_llm=llm, llm=browser_use_llm, task="", task="", card=agent_card, skill_set=[worker_skill, chatter_skill], tasks=[worker_task, chatter_task])
