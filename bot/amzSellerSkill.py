...
def genWinChromeAMZFullfillOrdersSkill(worksettings, stepN, theme):
    ...
    this_step, step_words = genStepCreateData("string", "amz_status", "NA", "", this_step)
    psk_words = psk_words + step_words
...
def genWinChromeAMZCollectOrdersSkill(worksettings, stepN, theme):
    ...
    this_step, step_words = genStepStub("end skill", "public/win_chrome_amz_orders/collect_orders", "", this_step)
    psk_words = psk_words + step_words
...
def genWinChromeAMZUpdateShipmentTrackingSkill(worksettings, stepN, theme):
    ...
    this_step, step_words = genStepStub("end skill", "public/win_chrome_amz_orders/update_tracking", "", this_step)
    psk_words = psk_words + step_words
