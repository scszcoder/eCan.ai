...
def genADSPowerLaunchSteps(worksettings, stepN, theme):
    try:
        ...
        this_step, step_words = genStepOpenApp("run", True, "AdsPower", "sk_work_settings['app_exe']", "expr", "sk_work_settings['cargs']", "topWin", 3, "actionSuccess", this_step)
        psk_words = psk_words + step_words
...
def genStepsADSPowerExitProfile(worksettings, stepN, theme):
    try:
        ...
        this_step, step_words = genStepMouseClick("Single Click", "", True, "screen_info", "text_file", "anchor text", "", 1, "center", [0, 0], "box", 2, 3, [0, 0], this_step)
        psk_words = psk_words + step_words
...
def genStepsADSBatchExportProfiles(worksettings, theme, stepN):
    try:
        ...
        this_step, step_words = genStepMouseClick("Single Click", "", True, "screen_info", "text_file", "anchor text",
                                                  "", 1, "center", [0, 0], "box", 2, 3, [0, 0], this_step)
        psk_words = psk_words + step_words
...
def genStepADSGenXlsxBatchProfiles(vehicle_name, vtasks_name, output, stepN):
        stepjson = {
...
def processADSGenXlsxBatchProfiles(step, i):
    ...
    try:
        ...
        vehicle_name = symTab[step["vehicle_name"]]
        formADSProfileBatches(vTasks, vehicle_name)
