...
from bot.basicSkill import symTab, processHalt, processWait, processSaveHtml, processTextToNumber, processExtractInfo, \
    ...
    processLogCrossNetwork8, processLog
...
RAIS = {
    ...
    "Log": lambda x, y, z: processLog(x, y, z),
    ...
    "Gen Resp Msg": lambda x, y, z: processGenRespMsg(x, y, z),
    ...
    "ECB Fetch Daily Schedule": lambda x, y, z: processECBFetchDailySchedule(x, y, z),
    "ECB Dispatch Troops": lambda x, y, z: processECBDispatchTroops(x, y, z),
    ...
    if foundSkill:
        if "ads" in foundSkill.getApp().lower():
            ...
            if foundBot:
                ...
                if bot_email in symTab.get("loaded_profiles", []):
                    ...
                    print(f"WARNIGN: bot {bot_email} not loaded yet.")
            else:
                print(f"WARNIGN: bot {botid} not found.")
        else:
