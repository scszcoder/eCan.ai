...
# Try relative imports first (when used as part of ecan_ai package)
# Fall back to absolute imports (when run as standalone CLI from project root)
try:
    from ..core import get_engine, ECAN_BASE_DB
    from . import MigrationManager
except ImportError:
    # Add project root to path for standalone CLI usage
