...
# =====================================================================
#
# This is adapted from browser-use examples/features/chat_polling_capture.py
# and works entirely through browser-use's public API.  No source
# modifications to browser-use are needed.
# =====================================================================
...
class PollingCapture:
    ...
    def __init__(
        ...
        self._enabled = False
        # Store captured responses for test assertions
