...
class PMGBaseEditor(PMAbstractEditor):
    ...
    def __init__(self, parent):
        ...
        trans_editor_tb.load(
            ...
            os.path.join(app_info.app_resources_path, 'translation', 'pyeditor_%s.qm' % QLocale.system().name()))
    ...
    def show_cursor_pos(self):
        ...
        self.status_label.setText(
            'Row: {row}, Column: {col}'.format(row=row + 1, col=col + 1))
    ...
    def _init_actions(self) -> None:
        ...
        self.icon_path = os.path.join(app_info.app_resources_path, 'images')
