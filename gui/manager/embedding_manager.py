...
class EmbeddingManager:
    ...
    def _load_and_merge_local_provider_models(self):
        ...
        try:
            ...
            # Merge RyoAIS models
            merge_ryoais_models_to_config_providers(all_providers, provider_type='embedding')
            
        except Exception as e:
            logger.warning(f"[EmbeddingManager] Failed to load local provider models during init: {e}")
