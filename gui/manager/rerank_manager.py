        ...
        for provider_name, provider_config in rerank_config.get_all_providers().items():
            ...
            if 'ollama' in provider_config.name.lower() or 'ollama' in provider_config.provider.value.lower():
                try:
                    ...
                    if main_window and general_settings.ollama_rerank_model:
                        preferred_model = general_settings.ollama_rerank_model
                except Exception:
                    pass
                ...
                try:
                    ...
                    if main_window and general_settings.ryoais_rerank_model:
                        preferred_model = general_settings.ryoais_rerank_model
                except Exception:
