...
class MenuMessages:
    ...
    MESSAGES = {
        'en-US': {
            ...
            'rla_attach_dialog_title': 'Select screenshots or screen recordings',
            'rla_ok': 'Upload',
            'rla_cancel': 'Cancel',
            'rla_packaging': 'Packaging and uploading…',
            'rla_no_skills': '(No skills found)',
            'rla_desc_required': 'Please describe the problem before uploading.',
            'rla_confirm_title': 'Confirm upload',
            'rla_confirm_msg': 'Upload your description, {n} attachment(s), the selected skills, and the full runlogs to the support team?',
            'rla_complete_title': 'Upload Complete',
        ...
        'zh-CN': {
            ...
            'rla_attach_dialog_title': '选择截图或录屏文件',
            'rla_ok': '上传',
            'rla_cancel': '取消',
            'rla_packaging': '正在打包并上传…',
            'rla_no_skills': '（未找到技能）',
            'rla_desc_required': '请先填写问题描述再上传。',
            'rla_confirm_title': '确认上传',
            'rla_confirm_msg': '将上传您的问题描述、{n} 个附件、所选技能以及完整的 runlogs 日志，确认继续？',
            'rla_complete_title': '上传完成',
