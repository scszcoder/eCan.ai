...
def launchChat(mwin):
    with gr.Blocks() as chat_app:
        with gr.Row():
            ...
            # Chat and Phonebook Layout
            with gr.Column(scale=4):
                chat_area = gr.Chatbot(label="Chat", height=400)
                ...
                # Phonebook area, shown when clicking phonebook menu item
                bot_selection = gr.Dropdown(choices=bots_list, label="Select Bot")
        ...
        phonebook_button.click(switch_bot, inputs=bot_selection, outputs=[chat_area, output_message])
