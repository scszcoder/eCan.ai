...
class SplashMessages:
    ...
    MESSAGES = {
        'en-US': {
            ...
            # main.py progress messages
            'init_python_env': 'Initializing APP environment...',
            'loading_core_modules': 'Loading core modules...',
            'importing_std_libs': 'Importing standard libraries...',
            'loading_config': 'Loading configuration...',
            'setting_up_env': 'Setting up environment...',
            'loading_env_vars': 'Loading environment variables...',
            'starting_local_server': 'Starting local server...',
            'loading_login': 'Loading Login components...',
            'loading_webgui': 'Loading WebGUI components...',
            'patching_browser': 'Patching browser-use to UTF-8...',
            'init_app': 'Initializing application...',
            'setting_up_app_info': 'Setting up application info...',
            'init_app_context': 'Initializing application context...',
            'verifying_icons': 'Verifying application icons...',
            'creating_event_loop': 'Creating event loop...',
            'preparing_preload': 'Preparing background preload...',
            'init_login_system': 'Initializing login system...',
            'config_runtime': 'Configuring runtime mode...',
            'creating_ui': 'Creating main interface...',
            'setting_up_url': 'Setting up URL scheme handling...',
            'finalizing': 'Finalizing setup...',
            # splash.py worker phases
        ...
        'zh-CN': {
            ...
            'importing_std_libs': '导入标准库...',
            'loading_config': '加载配置...',
            'setting_up_env': '设置环境...',
            'loading_env_vars': '加载环境变量...',
            'starting_local_server': '启动本地服务器...',
            'loading_login': '加载登录组件...',
            'loading_webgui': '加载 WebGUI 组件...',
            'patching_browser': '修补浏览器为 UTF-8...',
            'init_app': '初始化应用程序...',
            'setting_up_app_info': '设置应用信息...',
            'init_app_context': '初始化应用上下文...',
            'verifying_icons': '验证应用图标...',
            'creating_event_loop': '创建事件循环...',
            'preparing_preload': '准备后台预加载...',
            'init_login_system': '初始化登录系统...',
            'config_runtime': '配置运行时模式...',
            'creating_ui': '创建主界面...',
            'setting_up_url': '设置 URL 协议处理...',
            'finalizing': '完成设置...',
            # splash.py worker phases
            'init_services': '初始化服务...',
            'preparing_gui': '准备界面...',
